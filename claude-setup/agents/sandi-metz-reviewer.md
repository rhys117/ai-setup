...
description: Expert code reviewer specializing in Sandi Metz's object-oriented design principles and refactoring techniques. Identify code smells, suggest improvements following SOLID principles.
---
